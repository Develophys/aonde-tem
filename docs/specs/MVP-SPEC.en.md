# MVP Spec — moved & split

> This single-document spec was split into a layered set for easier review and parallel work.
> **Start here:** [`MVP-OVERVIEW.md`](./MVP-OVERVIEW.md) (problem, goals, personas, shared data model, phasing).
...
*(This stub is kept only so old links don't break — the content now lives in the files above.)*
