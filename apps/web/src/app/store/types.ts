...
import type { ReportDraftSlice } from "../../features/report/model/report-draft.slice.js";
...
export type AppStore = MapSlice & SessionSlice & ReportDraftSlice & UiSlice & ToastSlice;
